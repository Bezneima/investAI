...
public class Firebase {// Пока не дописал, тк нужно торопиться написать хотябы пример работы

    private static final String DATABASE_URL = "https://investingai-a8694.firebaseio.com/";
